...
// Structure: Section (FRAME, HORIZONTAL) > Text (FRAME, VERTICAL) > [Version, Date] + Content
...
figma.ui.onmessage = async (msg: { type: string; nodeId?: string; entries?: ChangelogEntry[] }) => {
    ...
    if (msg.type === 'create-changelog-entries') {
        ...
        try {
            ...
            const listFrame = listNode as FrameNode;
